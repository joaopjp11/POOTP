...
public:
    ...
    void AddAnimal(const Animal &a); //Adiciona animal à lista de animais na reserva
    void AddAlimento(const Alimento &a); //Adiciona alimento à lista de alimentos na reserva
    ...
    void listPosicao(int nl, int nc)const; //Faz descrição da posição (linha=nl, coluna=nc)
